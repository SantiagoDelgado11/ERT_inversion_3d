...
class PhysicsInformer:
    ...
    def compute_grad_u_pri(self, coords, r_A, r_B, I, sigma_0=5e-3):
        eps = 1e-6
        r_dist_A = coords - r_A
    ...
    def compute_u_pri(self, coords, source_coords, I, sigma_0=5e-3):
    ...
    def compute_pde_loss(self, coords, source_coords, I, gamma, sigma_0=5e-3):
...
class PhysicsInformer:
    ...
    def compute_reg_loss(self, coords, rho_bg=200.0):
        ...
        rho = 1.0 / sigma
        loss_bg = torch.mean(((rho - rho_bg)**2) * depth_weight) * 1e-4
