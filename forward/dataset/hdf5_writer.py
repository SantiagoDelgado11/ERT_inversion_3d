...
class HDF5Writer:
    ...
    def append_batch(self, samples):
        ...
        core_rho_batch = 1.0 / np.array([self._extract_core_sigma(s['sigma']) for s in samples], dtype=np.float32)
        ...
        self.file['labels/true_resistivity_3d'][current_size:new_size] = core_rho_batch
